...
class LoggerLoggingEvent
{
    ...
    )
    {
        ...
        if (($timeStamp !== null) && (is_numeric($timeStamp) === true)) {
            $this->timeStamp = $timeStamp;
        } else {
            $this->timeStamp = microtime(true);
        }//end if
        
        if (($throwable !== null) && ($throwable instanceof Exception === true)) {
    ...
    public function getLocationInformation()
    {
        ...
        if ($this->locationInfo === null) {
            ...
            if (isset($prevHop['class']) === true) {
                $locationInfo['class'] = $prevHop['class'];
            } else {
                $locationInfo['class'] = 'main';
            }//end if
            
            if ((isset($prevHop['function']) === true) 
    ...
    {
        if ($this->ndcLookupRequired === true) {
    ...
    public function getRenderedMessage()
    {
        ...
        if (($this->renderedMessage === null) && ($this->message !== null)) {
            ...
            if (is_string($this->message) === true) {
    ...
    {
        if (isset(static::$startTime) === false) {
