...
class LoggerLayoutXml extends LoggerLayout
{
    ...
    {
        if ($this->getLog4jNamespace() === true) {
    ...
    public function getHeader()
    {
        ...
        $out .= 'version="0.3" includesLocationInfo="'.(($this->getLocationInfo() === true) ? 'true' : 'false').'">';
        $out .= PHP_EOL;
