...
class Logger
{
    ...
    public function debugInit()
    {
        ...
        if (isset($trace[1]['function']) === true) {
    ...
    public function log(LoggerLevel $level, $message, Exception $throwable=null)
    {
        ...
        if ($this->isEnabledFor($level) === true) {
        ...
        if ((isset($this->parent) === true) && ($this->getAdditivity() === true)) {
    ...
    public function logEvent(LoggerLoggingEvent $event)
    {
        ...
        if ($this->isEnabledFor($event->getLevel()) === true) {
            $this->callAppenders($event);
        }//end if
    ...
    public function removeAppender($appender)
    {
        ...
        } elseif ((is_string($appender) === true) && (isset($this->appenders[$appender]) === true)) {
    ...
    public static function getHierarchy()
    {
        ...
        if (isset(static::$hierarchy) === false) {
    ...
    private static function getConfigurator($configurator=null)
    {
        ...
        if (is_object($configurator) === true) {
        ...
        if (is_string($configurator) === true) {
            ...
            if (($instance instanceof LoggerConfigurator) === false) {
