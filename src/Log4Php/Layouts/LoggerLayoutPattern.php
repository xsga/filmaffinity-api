...
class LoggerLayoutPattern extends LoggerLayout
{
     ...
     * @access public
     */
    public const DEFAULT_CONVERSION_PATTERN = '%date %-5level %logger %message%newline';
     ...
     * @access public
     */
    public const TTCC_CONVERSION_PATTERN = '%d [%t] %p %c %x - %m%n';
     ...
     * Activate options.
     *
     * Processes the conversion pattern and creates a corresponding chain of pattern converters which will be used
     * to format logging events.
     *
     * @return void
     *
