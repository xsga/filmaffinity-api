...
class LoggerConfigurationAdapterINI implements LoggerConfigurationAdapter
{
     ...
     * @access public
     */
    public const ROOT_LOGGER_NAME = 'root';
     ...
     * @access public
     */
    public const ADDITIVITY_PREFIX = 'log4php.additivity.';
     ...
     * @access public
     */
    public const THRESHOLD_PREFIX = 'log4php.threshold';
     ...
     * @access public
     */
    public const ROOT_LOGGER_PREFIX = 'log4php.rootLogger';
     ...
     * @access public
     */
    public const LOGGER_PREFIX = 'log4php.logger.';
     ...
     * @access public
     */
    public const APPENDER_PREFIX = 'log4php.appender.';
     ...
     * @access public
     */
    public const RENDERER_PREFIX = 'log4php.renderer.';
